...
Future<List<CartItemModel>> loadCartItems() async {
  ...
  final String cartURL = await buildApiUrl('/api/cart/');
...
Future<bool> addToCart({
  ...
  final String cartAddURL = await buildApiUrl('/api/cart/add/');
...
Future<bool> deleteCartItem(int cartId) async {
  ...
  final String cartDeleteURL = await buildApiUrl('/api/cart/$cartId/');
...
Future<bool> deleteSelectedCartItems(List<int> cartIds) async {
  ...
  final String bulkDeleteURL = await buildApiUrl('/api/cart/bulk-delete/');
...
Future<bool> clearCart() async {
  ...
  final String clearURL = await buildApiUrl('/api/cart/clear/');
